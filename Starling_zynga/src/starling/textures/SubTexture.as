...
package starling.textures
{
    ...
    public class SubTexture extends Texture
    {
		...
		public override function incRefCount():void {
			super.incRefCount();
			mParent.incRefCount();
		}
		
		/** Decrements the reference count for this texture, and if 0 disposes the teture. */
		public override function decRefCount():void {
			super.decRefCount();
			mParent.decRefCount();
		}		
