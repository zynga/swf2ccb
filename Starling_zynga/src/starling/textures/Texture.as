...
package starling.textures
{
    ...
    public class Texture
    {
		...
		/** Has this texture been disposed. */
		public function get isDisposed():Boolean {
			return mIsDisposed;
		}

		/** Increments the reference count for this texture. */
		public function incRefCount():void {
			mRefCount++;
		}
		
		/** Decrements the reference count for this texture. */
		public function decRefCount():void {
			mRefCount--;
		}
		
		/** The current texture reference count. */
		public function get refCount():int {
			return mRefCount;
		}
        
		/** The texture atlas for this texture if it has one. */
