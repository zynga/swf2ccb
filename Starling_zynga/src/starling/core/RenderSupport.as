...
package starling.core
{
    ...
    public class RenderSupport
    {
		...
		private static var sHelperScissorRect:Rectangle = new Rectangle();
		
		public function pushScissorRectangle(localRect:Rectangle):void {
			sHelperScissorRect.x = localRect.x + mModelViewMatrix.tx;
			sHelperScissorRect.y = localRect.y + mModelViewMatrix.ty;
			sHelperScissorRect.width = localRect.width;
			sHelperScissorRect.height = localRect.height;
			mScissorRectStack.push(mScissorRectangle.clone());
			this.scissorRectangle = sHelperScissorRect;
		}
		
		public function popScissorRectangle():void {
			var rect:Rectangle = mScissorRectStack.pop();
			if (rect.isEmpty()) {
				this.scissorRectangle = null;
			} else {
